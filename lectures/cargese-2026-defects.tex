...
Therefore
\begin{equation}
  \vev{\cO(y,z)}_{\cD}=\frac{a_\cO}{|z|^\Delta} .
  \label{eq:onepoint}
\end{equation}
...
\begin{equation}
  \beta_\lambda=-\epsilon\lambda+\frac{1}{2}\vol(S^{p-1})C_{\widehat\cO\widehat\cO\widehat\cO}\lambda^2+O(\lambda^3).
  \label{eq:defectbeta}
\end{equation}
...
\begin{equation}
  \widehat\Delta_{\chi^\dagger\chi}=1 .
